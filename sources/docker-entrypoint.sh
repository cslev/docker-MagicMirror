...
### WHILE IT SEEMED TO BE A GOOD IDEA TO HAVE INPUT PARAMS TO INSTALL ADDITIONAL MODULES EASILY
### IT CAN A HUGE OVERHEAD EVERYTIME WE RESTART THE CONAINER WITH ENV VARIABLES UNCHANGED
# LET'S COMMENT THEM FOR NOW, BUT LEAVE FOR REFERENCE 
